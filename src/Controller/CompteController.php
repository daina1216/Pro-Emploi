...
{
    #[Route('/compte', name: 'app_compte_index', methods: ['GET'])]
    ...
    #[Route('/compte/new', name: 'app_compte_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/compte/{id}', name: 'app_compte_show', methods: ['GET'])]
    ...
    #[Route('/compte/{id}', name: 'app_compte_delete', methods: ['POST'])]
